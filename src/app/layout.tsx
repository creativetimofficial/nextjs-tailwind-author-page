...
export const metadata: Metadata = {
  ...
  keywords:
    "author page, author page template, author template, blog, blog page, blog template, tailwind, tailwind css, tailwind template, tailwind theme, author bio, writer page, writer page template, writer, author, bio, personal website.",
};
